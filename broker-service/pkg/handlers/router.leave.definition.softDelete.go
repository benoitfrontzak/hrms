...
// forward the post request from the front-end to employee-service to create a new leave definition
func SoftDeleteLeaveDefinition(w http.ResponseWriter, r *http.Request) {
	// send post request to employee-service and collect the response
	url := leaveService + "api/v1/leave/definition/softDelete"
