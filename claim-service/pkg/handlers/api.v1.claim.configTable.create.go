...
// CreateEmployeeCT is the handler which receives
// an employee's CT payload from the broker
// convert it and inserts it to the DB
func (rep *Repository) CreateClaimCT(w http.ResponseWriter, r *http.Request) {
	...
	rowID, err := rep.App.Models.ConfigTables.Insert(dbTableName, p.Entry)
	if err != nil {
