...
func (rep *Repository) MyClaim(w http.ResponseWriter, r *http.Request) {
	// Check URL
	if !strings.HasPrefix(r.URL.Path, "/myclaim/") {
	...
	case 2:
		render.RenderTemplate(w, "admin.myClaim.page.gohtml", td)
	case 3:
		render.RenderTemplate(w, "manager.myClaim.page.gohtml", td)
	case 4:
