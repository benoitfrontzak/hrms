...
func (rep *Repository) LeaveEmployee(w http.ResponseWriter, r *http.Request) {
	// Check URL
	if !strings.HasPrefix(r.URL.Path, "/leave/employee/") {
		http.Error(w, "404 not found man.", http.StatusNotFound)
		return
	}
	...
	case 2:
		render.RenderTemplate(w, "admin.leave.employee.page.gohtml", td)
	case 3:
		render.RenderTemplate(w, "manager.leave.employee.page.gohtml", td)
	default:
		var empty any
		render.RenderTemplate(w, "unauthorized.page.gohtml", empty)
	}
