...
func (rep *Repository) ClaimEmployee(w http.ResponseWriter, r *http.Request) {
	// Check URL
	if !strings.HasPrefix(r.URL.Path, "/claim/employee/") {
	...
	case 2:
		render.RenderTemplate(w, "admin.claim.employee.page.gohtml", td)
	default:
		var empty any
		render.RenderTemplate(w, "unauthorized.page.gohtml", empty)
	}
